...
description: The five iPhone settings that actually matter -- not the top fifty. Free, with a checklist to track it.
---

import HardenChecklist from '../../components/HardenChecklist.svelte';
import { checklistFor } from '../../lib/harden/checklists';

export const guide = checklistFor('iphone');
