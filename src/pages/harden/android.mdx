...
description: Delete your advertising ID, the name tag the broker economy runs on -- and the rest of what actually matters. Free, with a checklist.
---

import HardenChecklist from '../../components/HardenChecklist.svelte';
import { checklistFor } from '../../lib/harden/checklists';

export const guide = checklistFor('android');
